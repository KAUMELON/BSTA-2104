...
The function $f(x,y)$; if it can be expressed by writing $x = kx$ and $y = ky$ to form a function $f(kx,ky)= k^{2} f(x,y)$, such that constant $k$ can be taken as the $n^{th}$ power of exponent , it is called as homogeneous function of degree $n$. Here $n$ is called as the *degree of homogeneity*.
